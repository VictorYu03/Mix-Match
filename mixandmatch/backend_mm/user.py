...
dbconfig = {
    ...
    "password": 'Yz197358246!',  # MySQL password
    "host": 'localhost',  # IP address or hostname
    "database": 'mixnmatch',  # MySQL database
    "pool_name": "mypool",
...
class UserAPI(MethodView):
    ...
    def create_user(self):
        ...
        try:
            with self.get_connection() as cnx:
                ...
                # category_query = "INSERT INTO user_category (user_id, category) VALUES (%s, %s)"
                # category_data = (user_id, 'HUMAN')  # Default category as 'HUMAN'
    ...
    def onboard(self,user_id):
        ...
        try:
            with self.get_connection() as cnx:
                ...
                query_category = 'INSERT INTO user_category (user_id, category) VALUES (%s, %s)'
                ...
                cursor.execute(query_category, (user_data_2,'HUMAN'))
                cnx.commit()
    ...
    def get_chat(self):
        ...
        #         u.username,
        #         u.photo,
        #         COUNT(CASE WHEN msg.receiver_id = %s THEN 1 ELSE NULL END) AS unread_count
        #     FROM
    ...
    def match_user(self, other_user_id):
        ...
        try:
            with self.get_connection() as cnx:
                ...
                # match_data = (user_id, other_user_id, user_id, other_user_id)
        ...
        return jsonify({'message': f'Successfully updated match history with user_id: {other_user_id}',"user_id":user_id})
